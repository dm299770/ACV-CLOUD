...
public class Demo {
    ...
    protected JSONObject demoPushSingleDeviceMessageIOS() {
        ...
        remoteMessageIOS.setCustom(new HashMap<String,Object>());
    ...
    protected JSONObject demoPushAccountListMultiple() throws JSONException {
        ...
        if (ret.getInt("ret_code") != 0)
            ...
            // ...
            result.put("all", xinge.pushAccountListMultiple(ret.getJSONObject("result").getLong("push_id"), accountList1));

            List<String> accountList2 = new ArrayList<String>();
            accountList2.add("joelliu3");
            accountList2.add("joelliu4");
            // ...
            result.put("all", xinge.pushAccountListMultiple(ret.getJSONObject("result").getLong("push_id"), accountList2));
            return result;
        }
    }
    ...
    protected JSONObject demoPushDeviceListMultiple() throws JSONException {
        ...
        if (ret.getInt("ret_code") != 0)
            ...
            // ...
            result.put("all", xinge.pushDeviceListMultiple(ret.getJSONObject("result").getLong("push_id"), deviceList1));

            List<String> deviceList2 = new ArrayList<String>();
            deviceList2.add("joelliu3");
            deviceList2.add("joelliu4");
            // ...
            result.put("all", xinge.pushDeviceListMultiple(ret.getJSONObject("result").getLong("push_id"), deviceList2));
            return result;
        }
    }
